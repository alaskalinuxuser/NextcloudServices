...
public class NotificationService extends Service {
    ...
    public String nameOfApp(String appName) {
        if (appName.equals("spreed")) {
            return "com.nextcloud.talk2";
        } else if (appName.equals("deck")) {
            return "com.nextcloud.deck";
        } else {
            return "com.nextcloud.client";
        }
    }
    ...
    private void notificationSend(int id, String title, String text, String app, String app_name) {
        ...
        Notification notification = new NotificationCompat.Builder(getBaseContext(), app)
                ...
                .setAutoCancel(true)
                .setContentText(text)
                .addAction(iconByApp(app_name), app_name, notificationLaunchIntent(nameOfApp(app_name)))
                .build();
        mNotificationManager.notify(id, notification);
        
    }

    public PendingIntent notificationLaunchIntent(String appName) {
        ...
        if (launchIntent != null) {
            ...
            Log.i(TAG, "Package does not exist.");
        }
